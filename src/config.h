...
/* defined if exception abi::__forced_unwind exists */
#define HAVE_ABI_FORCED_UNWIND 1

/* Define to 1 if you have the `accept4' function. */
#define HAVE_ACCEPT4 1

/* Defined when openssl supports ASN1_TIME_diff (openssl 1.0.2) */
#define HAVE_ASN1_TIME_diff /**/
...
#define HAVE_TCP_DEFER_ACCEPT 1

/* Defined when TLS_method is found in openssl library */
#define HAVE_TLS_METHOD /**/
...
#define PACKAGE_STRING "cxxtools 3.1"
